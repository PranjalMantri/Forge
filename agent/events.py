...
class AgentEvent:
    ...
    @classmethod
    def text_complete(
        cls, content: str | None = "", usage: TokenUsage | None = None
    ) -> AgentEvent:
        return cls(
            type=AgentEventType.TEXT_COMPLETE, data={"content": content, "usage": usage}
        )

    @classmethod
    def reasoning_delta(cls, content: str) -> AgentEvent:
        return cls(type=AgentEventType.REASONING_DELTA, data={"content": content})
